...
export default class EspecialidadMaquinariaValidator {
  ...
  public schema = schema.create({
    ...
    especialidad_id: schema.number([ // Validación del nuevo campo
  ...
  public messages: CustomMessages = {
    ...
    'especialidad_id.required': 'El ID de la especialidad es obligatorio.', // Mensaje para el nuevo campo
    'especialidad_id.exists': 'La especialidad especificada no existe.', // Mensaje para el nuevo campo
