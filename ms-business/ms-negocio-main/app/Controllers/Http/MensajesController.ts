...
export default class MensajesController {
    ...
    public async update({ params, request }: HttpContextContract) {
        ...
        // Eliminar la variable 'data' que se declara pero no se usa
        // const data = {
        ...
        theMensaje.contenido = payload.contenido;
        theMensaje.chat_id = payload.chat_id;
        theMensaje.user_id = payload.user_id;
        theMensaje.fecha = payload.fecha;
